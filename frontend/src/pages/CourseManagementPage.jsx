...
function CourseEditor(){
  ...
  if(loading)return <SkeletonStatus label="Loading course studio..."><Panel><Skeleton height={24} width="35%" radius={8} style={{marginBottom:22}} />{[0,1,2].map(i=><div key={i} style={{marginBottom:18}}><Skeleton height={12} width={120} style={{marginBottom:7}} /><Skeleton height={42} width="100%" radius={10} /></div>)}<Skeleton height={44} width={160} radius={10} /></Panel></SkeletonStatus>;
